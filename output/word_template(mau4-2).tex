...
\begin{figure}[H]
  ...
  \begin{subfigure}[b]{0.45\textwidth}
    \centering
    \includegraphics[width=\linewidth]{images/hinh_1.png}
    \caption{}
    \label{fig:hinh1_a}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.45\textwidth}
    \centering
    \includegraphics[width=\linewidth]{images/hinh_2.png}
    \caption{}
    \label{fig:hinh2_b}
  \end{subfigure}
  \caption{}
...
\begin{figure}[H]
  ...
  \begin{subfigure}[b]{0.45\textwidth}
    \centering
    \includegraphics[width=\linewidth]{images/hinh_3.png}
    \caption{}
    \label{fig:hinh3_a}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.45\textwidth}
    \centering
    \includegraphics[width=\linewidth]{images/hinh_4.png}
    \caption{}
    \label{fig:hinh4_b}
  \end{subfigure}
  \caption{}
...
\textbf{Bảng }\textbf{1. }\textit{Ảnh hưởng của một số loại cây trồng xen đến tỉ lệ mọc mầm, }
